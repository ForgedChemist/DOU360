...
const FloorMap = () => {
  ...
  const { zoomLevel, zoomActions, zoomIn: handleZoomIn, zoomOut: handleZoomOut } = useZoomLevel({
    min: 1.2,
    max: 2,
    step: 0.1,
  });
  ...
  const { handleRoomClickWithDragCheck } = useRoomClickHandler({
    dragDistance,
      ...
      <div className="flex flex-col md:flex-row w-full justify-center items-center md:items-start">
        ...
        <div className="flex flex-col items-center">
          ...
          >
              ...
              >
                <FloorMinusTwo zoomLevel={zoomLevel} dragOffset={dragOffset} handleRoomClickWithDragCheck={handleRoomClickWithDragCheck} zoomActions={zoomActions} />
            ...
            {currentFloor === 'floor0' && (
              ...
              >
                <FloorZero zoomLevel={zoomLevel} dragOffset={dragOffset} handleRoomClickWithDragCheck={handleRoomClickWithDragCheck} zoomActions={zoomActions} />
